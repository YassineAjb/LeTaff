...
const SizedBox(height: 10),
                    ...
                    const Text(
                      "NNotre expertise en matière de développement de logiciels, et nous nous distinguons par notre maîtrise des technologies de pointe telles que Vue.js, Laravel, React et Node.js. Grâce à notre expertise, nous sommes en mesure de concevoir et de créer des solutions web avancée.",
                      style: TextStyle(
                        color: Color.fromARGB(255, 255, 255, 255),
                        fontSize: 22.0,
                        height: 1.2,
...
Container(
  ...
  color: const ui.Color.fromARGB(255, 0, 0, 0),
  child: Center(
    child: Image.asset('assets/faq.jpg'),
  ),
),
const SizedBox(height: 30),
